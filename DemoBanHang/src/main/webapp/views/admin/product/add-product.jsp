...
<div class="grid_10">
	<div class="box round first grid">
		<h2>Thêm sản phẩm</h2>
		<div class="block">
		<c:url value="/quan-tri/product/saveadd" var="save" />
			<form:form action="${save }" method="POST" enctype="multipart/form-data" modelAttribute="product"> 
				<table class="form">

					<tr>
						<td><label>Tên sản phẩm</label></td>
						<td><form:input path="name" type="text" placeholder="Nhập tên sản phẩm..."
							class="medium" /></td>
					</tr>
					<tr>
						...
						<form:select id="select" path="catid">
					...
					<tr>
						<td style="vertical-align: top; padding-top: 9px;"><label>Mô tả</label>
						</td>
						<td><form:textarea path="desciption" class="tinymce"></form:textarea></td>
					</tr>
					<tr>
						<td><label>Giá</label></td>
						<td><form:input type="text" path="price" placeholder="Nhập giá..."
							class="medium" value="" /></td>
					</tr>
					<tr>
						<td><label>Giảm giá</label></td>
						<td><form:input type="text" path="discount" placeholder="Nhập mã giảm giá..."
							class="medium" value="" /></td>
					</tr>
 
					<tr>
						<td><label>Ảnh sản phẩm</label></td>
						<td><input multiple="multiple" name="filename" type="file" /></td>
					</tr>
