...
<!DOCTYPE HTML>
<head>
<title>website bán giày trung trực</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
<link href="css/style1.css" rel="stylesheet" type="text/css" media="all"/>
<link href="css/menu.css" rel="stylesheet" type="text/css" media="all"/>
<link href="css/nav.css" rel="stylesheet" type="text/css" media="all"/>
<link href="css/them.css" rel="stylesheet" type="text/css" media="all"/>
			...
			<div class="logo">
			  ...
			  <div class="header_top_right">
				...
				if(isset($_GET['customer_id'])){
					...
					// $delCompare = $cat->del_compare($customer_id);
					Session::destroy();
				}
			?>
		   <div class="login">
	...
	<ul id="dc_mega-menu-orange" class="dc_mm-orange">
	      ...
	      <li class="dropdown">
	       ...
	       <?php
			$login_check = Session::get('customer_login'); 
			if($login_check==false){
				echo ' <li class="active"><a href="cart.php">Giỏ hàng </a></li>';
			}else{
				echo '<li><a href="profile.php">Tài khoản</a> </li>';
				echo '<li><a href="orderdetails.php">Thông tin đặt hàng</a> </li>';
			}
			 ?>
