...
<?php
	...
	class cart
	{
		...
		public function add_to_cart($soluong,$size, $id){
			...
			$sId = session_id();
			$check_cart = "SELECT * FROM tbl_cart WHERE PID = '$id' AND SeId ='$sId'";
			...
			if($result_check_cart){
				...
				$query_insert = "INSERT INTO tbl_cart(PID,PName,SeId,PPrice,soluong,image,size) VALUES('$id','$productName','$sId','$price','$soluong','$image','$size')";
		...
		public function get_product_cart(){
			$sId = session_id();
			$query = "SELECT * FROM tbl_cart WHERE SeId = '$sId'";
		...
		public function del_all_data_cart(){
			$sId = session_id();
			$query = "DELETE FROM tbl_cart WHERE SeId = '$sId'";
			$result = $this->db->delete($query);
		...
		public function insertOrder($customer_id){
			...
			if($get_product){
				while($result = $get_product->fetch_assoc()){
					...
					$price = $result['PPrice'] * $quantity;
					$size = $result['size'];
					$image = $result['image'];
					$customer_id = $customer_id;
					$query_order = "INSERT INTO tbl_order(PID,PName,size,soluong,price,image,customer_id) VALUES('$productid','$productName','$size','$quantity','$price','$image','$customer_id')";
